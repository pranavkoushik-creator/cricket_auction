        ...
        <div className="relative w-full rounded-3xl">
          ...
          <div className="relative z-10 glass-panel rounded-3xl border border-white/7 px-9 pt-9 pb-8">
            ...
            <div className="flex flex-col items-center gap-2.5 mb-7">
              {/* <div className="w-[52px] h-[52px] rounded-full bg-yellow-500/10 border-2 border-yellow-500/30 flex items-center justify-center shadow-[0_0_16px_rgba(255,184,0,0.2)]">
